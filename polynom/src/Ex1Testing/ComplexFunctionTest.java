...
public class ComplexFunctionTest {
	...
	public void testErrInput() {
		...
		assertEquals(i, 9);
		try{
			ComplexFunction test =new ComplexFunction();
			test.initFromString("plus(div(1+x,mul(mul(3.0+x,-2.0,+x),-4.0+x)),2.0)");
		}
		catch(Exception f) {
			i++;
		}
	...
	public void testEquals() {
		ComplexFunction test1 =new ComplexFunction("2x+3+5x^4");	
